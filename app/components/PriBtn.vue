<template>
  ...
  >
    <div
      ...
      :class="`relative bg-orange-500 border-b-4 border-b-orange-700 border-t-2 border-t-white/50 px-6 py-2 rounded-full text-nowrap ${border} transition-all duration-300 ease-in-out overflow-hidden group`"
    >
      <div
